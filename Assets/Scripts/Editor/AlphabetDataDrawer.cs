...
public class AlphabetDataDrawer : Editor
{
    ...
    {
        IntializeReorderableList(ref AlphabetPlainList,"AlphabetPlain", "Alphabet Plain");
        IntializeReorderableList(ref AlphabetNormalList, "AlphabetNormal", "Alphabet Normal");
        IntializeReorderableList(ref AlphabetHighlightedList, "AlphabetHighlighted", "Alphabet Highlighted");
        IntializeReorderableList(ref AlphabetWrongList, "AlphabetWrong", "Alphabet Wrong");
    }
    ...
    public void IntializeReorderableList(ref ReorderableList list, string propertyName, string listLabel)
    {
